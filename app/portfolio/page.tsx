...
export const metadata: Metadata = {
  title: 'Portfolio - Mahbub E Waduzzaman | Web Development Projects & Case Studies',
  description: 'Explore Mahbub E Waduzzaman\'s portfolio of web development projects including React applications, Next.js websites, and full-stack solutions. View live demos and case studies.',
  keywords: 'portfolio, web development projects, react projects, next.js applications, full stack development, case studies',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-2">
            {categories.map((category, index) => (
              <button
                key={index}
                className={`btn ${index === 0 ? 'btn-primary' : 'btn-ghost'} btn-sm`}
              >
                {category}
              </button>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {projects.map((project, index) => (
              <div
                key={project.id}
                className="group bg-base-200 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden"
              >
